...
c3 = mc.chain(base+'final_paper_chains/tests_1x2pt/maglim/chain_1x2pt_s_b_lcdm_SR_maglim.txt')
...
samples5 = MCSamples(samples=samp5.T,names=['x1','x2'], labels=names, label='DES Y3 optimized', weights=c5.weight, settings={'boundary_correction_order':0, 'mult_bias_correction_order':1})
...
colours = ['#283594','#016E51','#000000','#8b008b']
#['#3775A1','#7223AD','#000000','#A4CD64']
g.triangle_plot([samples4,samples, samples5, samples2],['x1','x2'], filled=[True,True,False,True,True], contour_args=[{'alpha':0.6},{'alpha':0.6},{'alpha':1,'ls':'--'},{'alpha':0.6},{'alpha':0.6}], diag1d_kwargs={'normalized':True}, contour_colors=colours, labels=['DES Y3', 'Planck 2018'], param_limits={'x1':(0.18,0.51), 'x2':(0.6,1.0)}) #, markers=[[0.15,0.3,0.45], [0.6,0.7,0.8,0.9], [-2,-1,0,1,2,3]])
#import pdb ; pdb.set_trace()
...
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/TATT_NLA_vs_ext_2_maglim_v5_noDES_SN_BAO.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/TATT_NLA_vs_ext_2_maglim_v5_noDES_SN_BAO.png')