...
samp0 = np.array([c0.samples['intrinsic_alignment_parameters--a1'], c0.samples['intrinsic_alignment_parameters--a2'], c0.samples['intrinsic_alignment_parameters--alpha1'], c0.samples['intrinsic_alignment_parameters--alpha2'],c0.samples['intrinsic_alignment_parameters--bias_ta'] ])
...
#cc.configure(colors=['#800080', '#800080', '#FF1493', '#000000' ],shade=[False,True,True,False], shade_alpha=[0.25,0.25,0.25], max_ticks=4, kde=[6]*5, linestyles=["-", "-", '-.', '--'], legend_kwargs={"loc": "upper right", "fontsize": 14},label_font_size=14,tick_font_size=14) 
plt.close() ; 
fig = cc.plotter.plot(extents={'$S_8$':(0.5,0.95),r'$\Omega_{\rm m}$':(0.15,0.45),'$A_1$':(-5.,5), '$A_2$':(-5.,5), r'$\eta_1$':(-5,5), r'$\eta_2$':(-3,5), r'$b_{\rm TA}$':(0,2)}) #, truth=[0.3,0.82355,0.7,-1.7] )
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/wcdm_omegabh2_1x2pt_ia.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/wcdm_omegabh2_1x2pt_ia.png')
...
base = '/Volumes/groke/work/chains/y3/real/'
c1 = mc.chain(base+'chain_1x2pt_omegabh2_lcdm.txt')
...
samp0 = np.array([c0.samples['cosmological_parameters--omega_m'], c0.samples['cosmological_parameters--s8'], c0.samples['cosmological_parameters--omega_b']*c0.samples['cosmological_parameters--h0']**2 ])
samp1 = np.array([c1.samples['cosmological_parameters--omega_m'], c1.samples['cosmological_parameters--s8'], c1.samples['cosmological_parameters--omega_b']*c1.samples['cosmological_parameters--h0']**2 ])
...
names = [r'$\Omega_{\rm m}$','$S_8$',r'$\Omega_{\rm b}h^2$']
...
plt.subplots_adjust(bottom=0.185,left=0.185, hspace=0, wspace=0, top=0.92)

print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/lcdm_omegabh2_1x2pt.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/lcdm_omegabh2_1x2pt.png')
