...
base = '/Users/hattifattener/Documents/y3cosmicshear/chains/scale_cuts/'
c1 = mc.chain(base+'chain_fiducial_nla_v0.40_NLA_baseline.fits_scales_3x2pt_0.5_8_6_v0.4.ini_lcdm.txt')
c2 = mc.chain(base+'chain_fiducial_nla_v0.40_NLA_nl_bias_baryon.fits_scales_3x2pt_0.5_8_6_v0.4.ini_lcdm.txt')
...
cc.configure(colors=['#000000','#8b008b','#FF94CB', '#FF1493', ],shade=[False,True,True]*3, shade_alpha=[0.25, 0.25, 0.1,0.5], legend_kwargs={"loc": "upper right", "fontsize": 16},label_font_size=12,tick_font_size=14)
...
plt.close() ; 
fig = cc.plotter.plot(extents={'$S_8$':(0.75,0.95),r'$\Omega_{\rm m}$':(0.15,0.45),'$A_1$':(0.,1.2), '$A_2$':(-4.,1), r'$\eta_1$':(-4,0), r'$\eta_2$':(-5,2), r'$b_{\rm TA}$':(0,2)}) #, truth=[0.3,0.82355,0.7,-1.7] )
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/scale_cuts/3x2pt_scale_cuts_nla.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/scale_cuts/3x2pt_scale_cuts_nla.png')
