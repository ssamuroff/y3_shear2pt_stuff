...
samp2 = np.array([c2.samples['cosmological_parameters--omega_m'], c2.samples['cosmological_parameters--s8'], c2.samples['cosmological_parameters--w'], c2.samples['intrinsic_alignment_parameters--a1'], c2.samples['intrinsic_alignment_parameters--a2'],c2.samples['intrinsic_alignment_parameters--alpha1'],c2.samples['intrinsic_alignment_parameters--alpha2'],c2.samples['intrinsic_alignment_parameters--bias_ta']])
...
names2 = [r'$\Omega_{\rm m}$','$S_8$','$w$', r'$A_1$', r'$A_2$', r'$\eta_1$', r'$\eta_2$', r'$b_{\rm TA}$']


cc.add_chain(samp1.T, parameters=names, weights=c1.weight, kde=True, name=r'$\Lambda$CDM')
cc.add_chain(samp2.T, parameters=names2, weights=c2.weight, kde=True, name=r'$w$CDM')
...
plt.suptitle(r'$1 \times 2\mathrm{pt}$', fontsize=22)
plt.subplots_adjust(bottom=0.155,left=0.155, top=0.98,right=0.98,hspace=0, wspace=0)

print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/unblinded_y3cs_de.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/unblinded_y3cs_de.png')
...
c2 = mc.chain(base+'chain_3x2pt_wcdm.txt')
...
plt.suptitle(r'$3 \times 2\mathrm{pt}$', fontsize=22)
plt.subplots_adjust(bottom=0.155,left=0.155, top=0.98,right=0.98,hspace=0, wspace=0)

print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/unblinded_y3_3x2pt_de.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/unblinded_y3_3x2pt_de.png')
