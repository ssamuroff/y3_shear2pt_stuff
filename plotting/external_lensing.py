...
samp2 = np.array([c2.samples['cosmological_parameters--omega_m'], c2.samples['cosmological_parameters--s8'], c2.samples['intrinsic_alignment_parameters--a'] ])
...
cc.add_chain(samp2.T, parameters=names, weights=c2.weight, kde=2., name=r'DES Y1')
...
samples3 = MCSamples(samples=samp2.T,names=['x1','x2','x3'], labels=names, label='DES Y1', weights=c2.weight, settings={'boundary_correction_order':0, 'mult_bias_correction_order':1})
