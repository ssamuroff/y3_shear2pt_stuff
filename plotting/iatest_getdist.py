...
colours = ['#12239E','#016E51','#000000','#FFA500']
#['#191970','#8b008b','#FF69B4','#228B22' ]

g.plot_2d([samples0, samples1, samples2, samples3, ],['x1','x2'], diag1d_kwargs={'normalized':True}, alphas=[0.6,0.6,1.,1.,0.6], ls=['-','-','-','-','-','-'],lws=[1.5]*5,filled=[True,True,False,False,True], colors=colours, labels=['DES Y3', 'HSC Y1', 'DES Y1', 'KiDS-1000', 'Planck 18'], lims=[0.15,0.48,0.7,0.9]) #, markers=[[0.15,0.3,0.45], [0.6,0.7,0.8,0.9], [-2,-1,0,1,2,3]])
#import pdb ; pdb.set_trace()
...
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/1x2pt_iatest_tatt_nla_s8omm_final.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/1x2pt_iatest_tatt_nla_s8omm_final.png')
