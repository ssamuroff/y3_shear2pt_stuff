...
exclude = ['like', 'cosmological_parameters--sigma_12', 'data_vector--2pt_chi2','shear_calibration_parameters--m1','shear_calibration_parameters--m2','shear_calibration_parameters--m3','shear_calibration_parameters--m4','wl_photoz_errors--bias_1','wl_photoz_errors--bias_2','wl_photoz_errors--bias_3','wl_photoz_errors--bias_4','lens_photoz_errors--bias_1','lens_photoz_errors--bias_2','lens_photoz_errors--bias_3','lens_photoz_errors--width_1','lens_photoz_errors--width_2','lens_photoz_errors--width_3','bias_lens--b1','bias_lens--b2','bias_lens--b3']
...
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/slightly_less_giant_cornerplot_prior_maglim.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/slightly_less_giant_cornerplot_prior_maglim.png')