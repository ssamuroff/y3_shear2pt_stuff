...
c2 = mc.chain(base+'chain_1x2pt_fiducial_test_0.40_CLASS_C1_DEEP2_twopoint_new.fits_scales_3x2pt_0.5_8_6_v0.4_nobin11.ini_lcdm.txt')
...
cc.add_chain(samp2.T, parameters=names, weights=c2.weight, kde=True, name=r'DEEP2, no $\xi^{11}_\pm$')
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/fiducial_test_0.40_CLASS_C1_DEEP2_v2_nobin11.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/fiducial_test_0.40_CLASS_C1_DEEP2_v2_nobin11.png')
