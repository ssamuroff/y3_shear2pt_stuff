...
cc.add_chain(samp2.T, parameters=names, weights=c2.weight, kde=True, name=r'wrong $n(z)$, $\Delta \chi^2 = 5.0$ ')
cc.add_chain(samp3.T, parameters=names, weights=c3.weight, kde=True, name=r'wrong $n(z)$, $\Delta \chi^2 = 3.0$')
cc.add_chain(samp4.T, parameters=names, weights=c4.weight, kde=True, name=r'wrong $n(z)$, $\Delta \chi^2 = 1.5$')
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/y3cs_tatt_iaxnz.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/cs2/y3cs_tatt_iaxnz.png')
