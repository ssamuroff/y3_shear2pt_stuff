...
c0 = mc.chain(base+'external/chain_p-lensing_wcdm.txt')
#c1 = mc.chain(base+'')
...
samp0 = np.array([c0.samples['cosmological_parameters--s8'], c0.samples['cosmological_parameters--w'], ])
samp1 = np.array([c1.samples['cosmological_parameters--s8'], c1.samples['cosmological_parameters--w'], c1.samples['intrinsic_alignment_parameters--a1'], c1.samples['intrinsic_alignment_parameters--a2'] ])
...
names = ['$S_8$','$w$']
names2 = ['$S_8$','$w$','$A_1$','$A_2$']


cc.add_chain(samp0.T, parameters=names, weights=c0.weight, kde=True, name=r'Planck Lensing')
cc.add_chain(samp1.T, parameters=names2, weights=c1.weight, kde=True, name=r'DES Y3')
...
plt.close() ; 
fig = cc.plotter.plot(extents={'$S_8$':(0.5,1.05),r'$\Omega_{\rm m}$':(0.15,0.45),'$A_1$':(-5.,5), '$A_2$':(-5.,5), r'$\eta_1$':(-5,5), r'$\eta_2$':(-5,2), r'$b_{\rm TA}$':(0,2)}, truth=[0.,-1,0.,0.] )
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/external_wcdm_ia_1x2pt.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/external_wcdm_ia_1x2pt.png')
