...
plt.close() ; 
fig = cc.plotter.plot(extents={'$S_8$':(0.69,0.85),r'$\sigma_8$':(0.6,0.95),r'$\Omega_{\rm m}$':(0.14,0.5),'$A_1$':(-1.4,3), '$A_2$':(-5.,4), r'$\eta_1$':(-5,5), r'$\eta_2$':(-5,5), r'$b_{\rm TA}$':(0,2)}) #, truth=[0.3,0.82355,0.7,-1.7] )
