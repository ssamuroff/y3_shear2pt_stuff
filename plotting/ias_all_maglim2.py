...
c1 = mc.chain('/Volumes/groke/work/chains/y3/real/final_paper_chains/tests_1x2pt/maglim/chain_TA_1x2pt_lcdm_maglim.txt')
c2 = mc.chain('/Volumes/groke/work/chains/y3/real/final_paper_chains/tests_1x2pt/maglim/chain_amplitudes_1x2pt_lcdm_maglim.txt')
c3 = mc.chain('/Volumes/groke/work/chains/y3/real/final_paper_chains/tests_1x2pt/maglim/chain_TATT_noz_1x2pt_lcdm.txt')
...
samp1 = np.array([c1.samples['cosmological_parameters--omega_m'], c1.samples['cosmological_parameters--s8'], c1.samples['intrinsic_alignment_parameters--a1'] ])
...
samples1 = MCSamples(samples=samp1.T,names=['x1','x2','x3'], labels=names, label=r'TA ($A_1,\eta_1,b_{\rm TA}$)', weights=c1.weight, settings={'boundary_correction_order':0, 'mult_bias_correction_order':1})
samples2 = MCSamples(samples=samp2.T,names=['x1','x2','x3'], labels=names, label='TATT no $z$', weights=c2.weight, settings={'boundary_correction_order':0, 'mult_bias_correction_order':1})
samples3 = MCSamples(samples=samp3.T,names=['x1','x2','x3'], labels=names, label=r'TATT no $\eta_1$', weights=c3.weight, settings={'boundary_correction_order':0, 'mult_bias_correction_order':1})
...
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/1x2pt_ias_all_getdist_maglim2_v2.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/1x2pt_ias_all_getdist_maglim2_v2.png')
