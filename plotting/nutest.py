...
cc.add_chain(samp1.T, parameters=names2, weights=c1.weight, kde=True, name=r'$\Omega_\nu h^2$ varied')
cc.add_chain(samp2.T, parameters=names2, weights=c2.weight, kde=True, name=r'$\Omega_\nu h^2$ fixed')
...
plt.close() ; 
fig = cc.plotter.plot(extents={'$S_8$':(0.68,0.89),r'$\Omega_{\rm m}$':(0.15,0.45),'$A_1$':(-2.,2), '$A_2$':(-5.,5), r'$\eta_1$':(-5,5), r'$\eta_2$':(-5,5), r'$b_{\rm TA}$':(0,2)}) #, truth=[0.3,0.82355,0.7,-1.7] )
...
print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/unblinded_nonu_1x2pt.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/unblinded_nonu_1x2pt.png')
