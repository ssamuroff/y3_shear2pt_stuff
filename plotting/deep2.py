...
c2 = mc.chain(base+'chain_1x2pt_fiducial_test_0.40_CLASS_NLA_C1_GAMA_twopoint_new.fits_scales_3x2pt_0.5_8_6_v0.4.ini_lcdm_btatest.txt')
...
#cc.add_chain(samp2.T, parameters=names, weights=c2.weight, kde=True, name=r'GAMA')
#
#
#
...
#plt.close() ; 
#fig = cc.plotter.plot(extents={'$S_8$':(0.75,0.95),r'$\Omega_{\rm m}$':(0.15,0.45),'$A_1$':(-0.9,2), '$A_2$':(-3.,1), r'$\eta_1$':(-5,5), r'$\eta_2$':(-5,2), r'$b_{\rm TA}$':(0,2)}, truth=[0.82355,0.3,0.2,2.8,-1.3,-2.5,0] )
#
#
...
#
#print('Saving...')
#plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/fiducial_test_0.40_CLASS_C1_DEEP2_v2.pdf')
#plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/fiducial_test_0.40_CLASS_C1_DEEP2_v2.png')
...
cc.configure(colors=['#000000','#8b008b','#ffd1df', '#FF1493', ],shade=[False,True,True]*3, shade_alpha=[0.25, 0.25, 0.5,0.5], legend_kwargs={"loc": "upper right", "fontsize": 10},label_font_size=10,tick_font_size=10)
#cc.configure(colors=['#800080', '#800080', '#FF1493', '#000000' ],shade=[False,True,True,False], shade_alpha=[0.25,0.25,0.25], max_ticks=4, kde=[6]*5, linestyles=["-", "-", '-.', '--'], legend_kwargs={"loc": "upper right", "fontsize": 14},label_font_size=14,tick_font_size=14) 
plt.close() ; 
fig = cc.plotter.plot(extents={r'$\Omega_{\rm m}$':(0.165,0.5),'$S_8$':(0.72,0.92),'$A_1$':(-0.9,2), '$A_2$':(-3.,1), r'$\eta_1$':(-5,5), r'$\eta_2$':(-5,2), r'$b_{\rm TA}$':(0,2)}) #, truth=[0.82355,0.3,0.2,2.8,-1.3,-2.5,0] )
#plt.xticks([0.2,0.3,0.4,0.5])

plt.suptitle(r'Simulated $\Lambda$CDM $1 \times 2\mathrm{pt}$', fontsize=11)
plt.subplots_adjust(bottom=0.22,left=0.22, top=0.93, right=0.99, hspace=0, wspace=0)

print('Saving...')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/2D_fiducial_test_0.40_CLASS_C1_DEEP2_v2.pdf')
plt.savefig('/Users/hattifattener/Documents/y3cosmicshear/plots/robustness/2D_fiducial_test_0.40_CLASS_C1_DEEP2_v2.png')
